...
_2026-07-02 · catgraph backend (post-K1) · release build_
...
| latency µs | 1.424 · 0.105 | 3.915 · 4.008 |
...
- Criterion 2 (latency): mag median 3.915 µs < aif median 1.424 µs → FAIL
...
- Path B.3 (bounded latency overhead): mag median 3.915 µs ≤ 10 × aif median 1.424 µs → PASS
